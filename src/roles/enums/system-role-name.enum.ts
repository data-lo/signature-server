 ...
 *   una organización; nadie lo otorga a mano. Trae el catálogo estático completo, y es el único
 *   con `MEMBER.REMOVE` (dar de baja a alguien de la organización) — ver
