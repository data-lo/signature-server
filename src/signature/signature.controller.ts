...
export class SignatureController {
  ...
  @Post()
  @ApiOperation({ summary: 'Registrar una nueva firma para el usuario autenticado' })
  ...
  @Patch(':id')
  @ApiOperation({ summary: 'Actualizar la imagen de firma y/o identificación oficial del usuario autenticado' })
  ...
  @Patch(':id/deactivate')
  @ApiOperation({ summary: 'Desactivar la firma del usuario autenticado reemplazándola por una imagen en blanco' })
